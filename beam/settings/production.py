...
BLOCKCHAIN_CREATE_BTC_ADDRESS_URL = BLOCKCHAIN_BASE_URL + 'api/receive'
BLOCKCHAIN_CONVERT_USD_TO_BTC_URL = BLOCKCHAIN_BASE_URL + 'tobtc'
BLOCKCHAIN_CONVERT_TO_BTC_URL = BLOCKCHAIN_BASE_URL + 'ticker'
BLOCKCHAIN_INVOICE_CALLBACK_URL = API_BASE_URL + '/api/v1/btc_payment/blockchain?invoice_id={}&signature={}&txn_id={}'
BLOCKCHAIN_DESTINATION_ADDRESS = '1ENNEzMRVdNoC1ZdbPrTdU4z72UNuus1Uj'
BLOCKCHAIN_INVOICE_TIMEOUT = 10
BLOCKCHAIN_REQUEST_TIMEOUT = 30
BLOCKCHAIN_MIN_CONFIRMATIONS = 1

# Coinapult API
if ENV in (ENV_LOCAL, ENV_DEV):
    COINAPULT_BASE_URL = 'https://playground.coinapult.com/'
    COINAPULT_API_KEY = '247e7f92e2cf60694a53eed3a8f537'
    COINAPULT_API_SECRET = 'af7ca0ea4189b8196560ad3ed40c7659caa2f18705766cf9264a5fad39dd'
else:
...
COINAPULT_INVOICE_TIMEOUT = 15
COINAPULT_REQUEST_TIMEOUT = 15
