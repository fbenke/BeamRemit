...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DocumentStatusChange.changed_by'
        db.alter_column(u'account_documentstatuschange', 'changed_by', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'DocumentStatusChange.document_type'
        db.alter_column(u'account_documentstatuschange', 'document_type', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'DocumentStatusChange.changed_by'
        db.alter_column(u'account_documentstatuschange', 'changed_by', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'DocumentStatusChange.document_type'
        db.alter_column(u'account_documentstatuschange', 'document_type', self.gf('django.db.models.fields.CharField')(max_length=40))
