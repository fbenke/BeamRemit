...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BeamProfile.accepted_privacy_policy'
        db.add_column(u'account_beamprofile', 'accepted_privacy_policy',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BeamProfile.accepted_privacy_policy'
        db.delete_column(u'account_beamprofile', 'accepted_privacy_policy')


    models = {
        u'account.beamprofile': {
            'Meta': {'object_name': 'BeamProfile'},
            'accepted_privacy_policy': ('django.db.models.fields.BooleanField', [], {}),
