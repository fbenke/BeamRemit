...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DocumentStatusChange.document_type'
        db.alter_column(u'account_documentstatuschange', 'document_type', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        ...
        u'account.documentstatuschange': {
            ...
            'document_type': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
