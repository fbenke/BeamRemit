...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BeamProfile.post_code'
        db.alter_column(u'account_beamprofile', 'post_code', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'BeamProfile.post_code'
        db.alter_column(u'account_beamprofile', 'post_code', self.gf('django.db.models.fields.CharField')(max_length=10))
