...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BeamProfile.signup_site_id'
        db.add_column(u'account_beamprofile', 'signup_site_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BeamProfile.signup_site_id'
        db.delete_column(u'account_beamprofile', 'signup_site_id')
    ...
    models = {
        u'account.beamprofile': {
            ...
            'signup_site_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
