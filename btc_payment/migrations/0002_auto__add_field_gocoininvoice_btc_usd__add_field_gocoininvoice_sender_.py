...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoCoinInvoice.btc_usd'
        db.add_column(u'btc_payment_gocoininvoice', 'btc_usd',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'GoCoinInvoice.sender_usd'
        db.add_column(u'btc_payment_gocoininvoice', 'sender_usd',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoCoinInvoice.btc_usd'
        db.delete_column(u'btc_payment_gocoininvoice', 'btc_usd')

        # Deleting field 'GoCoinInvoice.sender_usd'
        db.delete_column(u'btc_payment_gocoininvoice', 'sender_usd')
    ...
    models = {
        ...
        u'btc_payment.gocoininvoice': {
            ...
            'transaction': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'gocoin_voice'", 'unique': 'True', 'to': u"orm['transaction.Transaction']"})
        },
