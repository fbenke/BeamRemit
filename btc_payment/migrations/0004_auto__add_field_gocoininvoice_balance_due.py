...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoCoinInvoice.balance_due'
        db.add_column(u'btc_payment_gocoininvoice', 'balance_due',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoCoinInvoice.balance_due'
        db.delete_column(u'btc_payment_gocoininvoice', 'balance_due')
