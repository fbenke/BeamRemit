...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CoinapultInvoice'
        db.create_table(u'btc_payment_coinapultinvoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('transaction', self.gf('django.db.models.fields.related.OneToOneField')(related_name='coinapult_invoice', unique=True, to=orm['transaction.Transaction'])),
            ...
            ('btc_fiat', self.gf('django.db.models.fields.FloatField')(null=True)),
        ...
        db.send_create_signal(u'btc_payment', ['CoinapultInvoice'])


    def backwards(self, orm):
        # Deleting model 'CoinapultInvoice'
        db.delete_table(u'btc_payment_coinapultinvoice')
