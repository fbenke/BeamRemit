...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GoCoinInvoice'
        db.create_table(u'btc_payment_gocoininvoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('transaction', self.gf('django.db.models.fields.related.OneToOneField')(related_name='gocoin_payment', unique=True, to=orm['transaction.Transaction'])),
        ...
        db.send_create_signal(u'btc_payment', ['GoCoinInvoice'])


    def backwards(self, orm):
        # Deleting model 'GoCoinInvoice'
        db.delete_table(u'btc_payment_gocoininvoice')
    ...
    models = {
        ...
        u'btc_payment.gocoininvoice': {
            ...
            'transaction': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'gocoin_payment'", 'unique': 'True', 'to': u"orm['transaction.Transaction']"})
        },
