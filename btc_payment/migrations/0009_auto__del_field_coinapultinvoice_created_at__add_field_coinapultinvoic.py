...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CoinapultInvoice.created_at'
        db.delete_column(u'btc_payment_coinapultinvoice', 'created_at')

        # Adding field 'CoinapultInvoice.expires_at'
        db.add_column(u'btc_payment_coinapultinvoice', 'expires_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 14, 0, 0)),
                      keep_default=False)

        # Adding field 'CoinapultInvoice.completed_at'
        db.add_column(u'btc_payment_coinapultinvoice', 'completed_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CoinapultInvoice.created_at'
        db.add_column(u'btc_payment_coinapultinvoice', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 12, 14, 0, 0)),
                      keep_default=False)

        # Deleting field 'CoinapultInvoice.expires_at'
        db.delete_column(u'btc_payment_coinapultinvoice', 'expires_at')

        # Deleting field 'CoinapultInvoice.completed_at'
        db.delete_column(u'btc_payment_coinapultinvoice', 'completed_at')
    ...
    models = {
        ...
        u'btc_payment.coinapultinvoice': {
            'Meta': {'object_name': 'CoinapultInvoice'},
            'balance_due': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'btc_address': ('django.db.models.fields.CharField', [], {'max_length': '34'}),
            'btc_fiat': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'completed_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'expires_at': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_id': ('django.db.models.fields.CharField', [], {'max_length': '36'}),
            'state': ('django.db.models.fields.CharField', [], {'default': "'UNPD'", 'max_length': '4'}),
            'transaction': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'coinapult_invoice'", 'unique': 'True', 'to': u"orm['transaction.Transaction']"})
        },
