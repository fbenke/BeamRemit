...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BlockchainPayment.input_address'
        db.delete_column(u'btc_payment_blockchainpayment', 'input_address_id')

        # Adding field 'BlockchainPayment.invoice'
        db.add_column(u'btc_payment_blockchainpayment', 'invoice',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='payments', to=orm['btc_payment.BlockchainInvoice']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BlockchainPayment.input_address'
        db.add_column(u'btc_payment_blockchainpayment', 'input_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='payments', to=orm['btc_payment.BlockchainInvoice']),
                      keep_default=False)

        # Deleting field 'BlockchainPayment.invoice'
        db.delete_column(u'btc_payment_blockchainpayment', 'invoice_id')
