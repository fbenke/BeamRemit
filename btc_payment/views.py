...
class ConfirmBlockchainPayment(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            # make sure that this matches the settings one
            destination_address = request.QUERY_PARAMS['destination_address']
            if destination_address != settings.BLOCKCHAIN_DESTINATION_ADDRESS:
                raise APIException
