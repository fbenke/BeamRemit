...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExchangeRate.gbp_eur'
        db.add_column(u'pricing_exchangerate', 'gbp_eur',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExchangeRate.gbp_eur'
        db.delete_column(u'pricing_exchangerate', 'gbp_eur')
