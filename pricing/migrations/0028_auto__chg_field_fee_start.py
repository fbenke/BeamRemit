...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Fee.start'
        db.alter_column(u'pricing_fee', 'start', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Fee.start'
        db.alter_column(u'pricing_fee', 'start', self.gf('django.db.models.fields.DateTimeField')())
