...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Limit.sending_currency'
        db.add_column(u'pricing_limit', 'sending_currency',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Limit.sending_currency'
        db.delete_column(u'pricing_limit', 'sending_currency')
