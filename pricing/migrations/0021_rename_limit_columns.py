...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('pricing_limit', 'transaction_min_gbp', 'transaction_min')
        db.rename_column('pricing_limit', 'transaction_max_gbp', 'transaction_max')
        db.rename_column('pricing_limit', 'user_limit_basic_gbp', 'user_limit_basic')
        db.rename_column('pricing_limit', 'user_limit_complete_gbp', 'user_limit_complete')

    def backwards(self, orm):
        # Rename 'full_name' field to 'name'
        db.rename_column('pricing_limit', 'transaction_min', 'transaction_min_gbp')
        db.rename_column('pricing_limit', 'transaction_max', 'transaction_max_gbp')
        db.rename_column('pricing_limit', 'user_limit_basic', 'user_limit_basic_gbp')
        db.rename_column('pricing_limit', 'user_limit_complete', 'user_limit_complete_gbp')
