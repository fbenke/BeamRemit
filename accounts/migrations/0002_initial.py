...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_beamprofile', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='beam', unique=True, to=orm['auth.User'])),
            ('favourite_snack', self.gf('django.db.models.fields.CharField')(max_length=5)),
        ))
        db.send_create_signal(u'accounts', ['BeamProfile'])


    def backwards(self, orm):
        # Deleting model 'BeamProfile'
        db.delete_table(u'accounts_beamprofile')
    ...
    models = {
        u'accounts.beamprofile': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'beam'", 'unique': 'True', 'to': u"orm['auth.User']"})
        },
        u'auth.group': {
