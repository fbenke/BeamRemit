...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('pricing', '0029_add_missing_fees'),
    )

    def forwards(self, orm):
        # Adding field 'Transaction.fee'
        db.add_column(u'transaction_transaction', 'fee',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='transaction', null=True, to=orm['pricing.Fee']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.fee'
        db.delete_column(u'transaction_transaction', 'fee_id')
