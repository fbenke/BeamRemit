...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Recipient.notification_email'
        db.delete_column(u'transaction_recipient', 'notification_email')


    def backwards(self, orm):
        # Adding field 'Recipient.notification_email'
        db.add_column(u'transaction_recipient', 'notification_email',
