...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'transaction_transaction', 'amount_btc', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Transaction.amount_btc'
        db.alter_column(u'transaction_transaction', 'amount_btc', self.gf('django.db.models.fields.IntegerField')(null=True))
