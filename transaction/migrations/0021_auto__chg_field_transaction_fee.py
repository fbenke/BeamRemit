...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.fee'
        db.alter_column(u'transaction_transaction', 'fee_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['pricing.Fee']))

    def backwards(self, orm):

        # Changing field 'Transaction.fee'
        db.alter_column(u'transaction_transaction', 'fee_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pricing.Fee']))
    ...
    models = {
        ...
        u'transaction.transaction': {
            ...
            'fee': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'transaction'", 'to': u"orm['pricing.Fee']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
