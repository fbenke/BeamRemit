...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Recipient.name'
        db.delete_column(u'transaction_recipient', 'name')

        # Adding field 'Recipient.first_name'
        db.add_column(u'transaction_recipient', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Recipient.last_name'
        db.add_column(u'transaction_recipient', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Recipient.name'
        db.add_column(u'transaction_recipient', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Deleting field 'Recipient.first_name'
        db.delete_column(u'transaction_recipient', 'first_name')

        # Deleting field 'Recipient.last_name'
        db.delete_column(u'transaction_recipient', 'last_name')
