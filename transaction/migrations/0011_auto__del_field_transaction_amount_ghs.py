...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.amount_ghs'
        db.delete_column(u'transaction_transaction', 'amount_ghs')


    def backwards(self, orm):
        # Adding field 'Transaction.amount_ghs'
        db.add_column(u'transaction_transaction', 'amount_ghs',
