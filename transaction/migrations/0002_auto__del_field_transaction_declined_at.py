...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.declined_at'
        db.delete_column(u'transaction_transaction', 'declined_at')


    def backwards(self, orm):
        # Adding field 'Transaction.declined_at'
        db.add_column(u'transaction_transaction', 'declined_at',
