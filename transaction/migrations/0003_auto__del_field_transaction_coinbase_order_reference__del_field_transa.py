...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transaction.coinbase_order_reference'
        db.delete_column(u'transaction_transaction', 'coinbase_order_reference')

        # Deleting field 'Transaction.coinbase_button_code'
        db.delete_column(u'transaction_transaction', 'coinbase_button_code')


    def backwards(self, orm):
        # Adding field 'Transaction.coinbase_order_reference'
        db.add_column(u'transaction_transaction', 'coinbase_order_reference',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Adding field 'Transaction.coinbase_button_code'
        db.add_column(u'transaction_transaction', 'coinbase_button_code',
