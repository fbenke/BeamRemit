...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.sent_amount'
        db.add_column(u'transaction_transaction', 'sent_amount',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Transaction.sent_currency'
        db.add_column(u'transaction_transaction', 'sent_currency',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.sent_amount'
        db.delete_column(u'transaction_transaction', 'sent_amount')

        # Deleting field 'Transaction.sent_currency'
        db.delete_column(u'transaction_transaction', 'sent_currency')
