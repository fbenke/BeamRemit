...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.exchange_rate'
        db.alter_column(u'transaction_transaction', 'exchange_rate_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['pricing.ExchangeRate']))

    def backwards(self, orm):

        # Changing field 'Transaction.exchange_rate'
        db.alter_column(u'transaction_transaction', 'exchange_rate_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pricing.ExchangeRate']))
