...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.payment_processor'
        db.add_column(u'transaction_transaction', 'payment_processor',
                      self.gf('django.db.models.fields.CharField')(default='GOCO', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transaction.payment_processor'
        db.delete_column(u'transaction_transaction', 'payment_processor')
