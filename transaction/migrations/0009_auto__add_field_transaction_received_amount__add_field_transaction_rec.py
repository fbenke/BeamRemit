...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transaction.received_amount'
        db.add_column(u'transaction_transaction', 'received_amount',
    ...
    def backwards(self, orm):
        # Deleting field 'Transaction.received_amount'
        db.delete_column(u'transaction_transaction', 'received_amount')

        # Deleting field 'Transaction.receiving_country'
        db.delete_column(u'transaction_transaction', 'receiving_country')
